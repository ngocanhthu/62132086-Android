...
import ntu.thu62132086.appthitracnghiem_001.question.Question;
import ntu.thu62132086.appthitracnghiem_001.question.QuestionController;
...
//                Toast.makeText(ScreenSlidePagerActivity.this, i, Toast.LENGTH_SHORT).show();
        ...
        timer = new CounterClass(1 * 30 * 1000, 1000);
        timer.start();
